...
let right = 0;
let intervalId = null;
let windowSize = 3; // default sliding window size
...
// Render array with optional pointers
function renderArray(leftPointer = null, rightPointer = null, currentIndex = null) {
    ...
    for (let i = 0; i < array.length; i++) {
        ...
        if (i === currentIndex) div.classList.add("pointer-current");
